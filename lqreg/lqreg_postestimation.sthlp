{smcl}
{* *! version 2.0.0 23jun2016 N.Orsini, M.Bottai}{...}
{right: ({browse "http://www.stata-journal.com/article.html?article=up0037":SJ12-3: st0231_1})}
{hline}
...
{synopt:{it:{help twoway_options:twoway_options}}}add/modify the plot{p_end}
{synoptline}

{title:Description for lqregplot}

{pstd} Plot the exponential value of the regression coefficient with confidence bands against a
...
{phang}
{it:{help twoway_options}} modifies the plot produced by {cmd:lqreg} command.
...
{phang}{stata "lqreg mpg weight"}{p_end}

{pstd}Predicted quantiles{p_end}
{phang}{stata "lqregpred predq, plotvs(weight)"}{p_end}

{pstd}Plot smoothed regression coefficients versus a set of quantiles{p_end}
{phang}{stata "lqregplot weight, quantiles(.1(.1).9)"}{p_end}
...
{p 4 14 2}Article:  {it:Stata Journal}, volume 12, number 3: {browse "http://www.stata-journal.com/article.html?article=up0037":st0231_1},{break}
